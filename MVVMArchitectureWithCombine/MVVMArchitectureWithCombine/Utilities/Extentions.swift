...
extension UICollectionView {
    ...
    func setMessage(_ message : String , icon : String){
        ...
        msgLab.anchor(top: img.bottomAnchor, paddingTop: 10, bottom: nil, paddingBottom: 0, left: view.leadingAnchor, paddingLeft: 10, right: view.trailingAnchor, paddingRight: -10, width: 0, height: 75)
